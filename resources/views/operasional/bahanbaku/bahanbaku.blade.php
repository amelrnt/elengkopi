    ...
    <div class="container-lg">
        <div class="d-flex justify-content-end">
            <div class="text-right">
                <a class="btn btn-primary pull-right" href="/operasional/bahanbaku/create">Tambah Data</a>
            </div>
        </div>
        <br>
        <div class="card mb-4">
            <div class="card-header"><strong>Data Bahan Baku</strong></div>
            <div class="card-body">
                @error('error')
                    ...
                    <table class="table table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="row">
                                    <form action="/operasional/bahanbaku/{{ $bahanbakus->id }}/edit" method="get"
                                        class="col-md-4">
                                        <button type="submit" class="btn btn-primary me-2">
                                            <svg class="icon" style="color: white">
                                                <use xlink:href="admin/vendors/@coreui/icons/svg/free.svg#cil-pencil">
                                                </use>
                                            </svg>
                                    ...
                                    <form action="/operasional/bahanbaku/{{ $bahanbakus->id }}" method="post" class="col-md-4">
                                        @method('delete')
                                        @csrf
                                        <button type="submit" class="btn btn-danger me-2">
                                            <svg class="icon" style="color: white">
                                                <use xlink:href="admin/vendors/@coreui/icons/svg/free.svg#cil-trash">
                                                </use>
                                            </svg>
                                        </button>
