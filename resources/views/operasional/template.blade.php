...
<body>
    <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
            <li class="nav-item"><a class="nav-link" href="/operasional/dashboard">
                    <svg class="nav-icon">
                        <use xlink:href="admin/vendors/@coreui/icons/svg/free.svg#cil-speedometer"></use>
                    </svg> Dashboard</a></li>
            <li class="nav-title">Data Master</li>

            <li class="nav-item"><a class="nav-link" href="/operasional/bahanbaku">
                <svg class="nav-icon">
                    <use xlink:href="admin/vendors/@coreui/icons/svg/free.svg#cil-money"></use>
                </svg> Data Bahan Baku</a></li>
            <li class="nav-item"><a class="nav-link" href="/operasional/pembelianbahanbaku">
                    <svg class="nav-icon">
                        <use xlink:href="admin/vendors/@coreui/icons/svg/free.svg#cil-money"></use>
                    </svg> Pembelian Bahan Baku</a></li>

            <li class="nav-item"><a class="nav-link" href="/operasional/pemakaianbahanbaku">
                    <svg class="nav-icon">
                        <use xlink:href="admin/vendors/@coreui/icons/svg/free.svg#cil-notes"></use>
                    </svg> Pemakaian Bahan Baku</a></li>
