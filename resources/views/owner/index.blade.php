        ...
        <nav id="sidebar" class="">
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a class="has-arrow" href="#" aria-expanded="false"><span class="bi bi-folder"><svg
                                    ...
                                    </svg></span> <span class="mini-click-non">Data Master</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="pegawai" href="/admin"><span class="mini-sub-pro">Data Pegawai</span></a>
                                </li>

                        </li>
                        <li><a title="data barang" href="/barang"><span class="mini-sub-pro">Data Barang</span></a></li>
                    ...
                    <li>
                        <a class="has-arrow" href="#" aria-expanded="false"><span class="bi bi-person-video2"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                </svg></span> <span class="mini-click-non">Data Transaksional</span></a>
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="penjualan" href="/penjualan"><span class="mini-sub-pro">Penjualan</span></a>
                            </li>

                    </li>
                    <li><a title="ketersediaan" href="/ketersediaan"><span class="mini-sub-pro">Ketersediaan</span></a>
                    </li>

                    </li>
                    <li><a title="pemesanan" href="/pesan"><span class="mini-sub-pro">Pemesanan</span></a></li>
                    </li>
                    <li><a title="hasil" href="/hasil/index"><span class="mini-sub-pro">Hasil</span></a></li>
                    </li>
