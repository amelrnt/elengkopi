...
<body>
    <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
            <li class="nav-item"><a class="nav-link" href="/owner/dashboard">
                    <svg class="nav-icon">
                        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-speedometer"></use>
                    </svg> Dashboard</a></li>
            <li class="nav-title">Data Master</li>
            <li class="nav-item"><a class="nav-link" href="/owner/user">
                    <svg class="nav-icon">
                        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-user"></use>
                    </svg> Data Pegawai</a></li>
            <li class="nav-item"><a class="nav-link" href="/owner/menu">
                <svg class="nav-icon">
                    <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-money"></use>
                </svg> Data Menu</a></li>
            <li class="nav-item"><a class="nav-link" href="/owner/pembelianbahanbaku">
                    <svg class="nav-icon">
                        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-money"></use>
                    </svg> Pembelian Bahan Baku</a></li>

            <li class="nav-item"><a class="nav-link" href="/owner/transaksi">
                    <svg class="nav-icon">
